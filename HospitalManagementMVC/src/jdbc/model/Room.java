...
public class Room implements Schedulable {
    ...
    // Selektor untuk mengambil kapasitas ruangan
    public int getCapacity() {
        return capacity;
    }
    // Selektor untuk mengambil jumlah penghuni saat ini
    public int getCurrentOccupancy() {
        return currentOccupancy;
    }
    // Mutator untuk mengatur jumlah penghuni saat ini (digunakan saat load dari DB)
